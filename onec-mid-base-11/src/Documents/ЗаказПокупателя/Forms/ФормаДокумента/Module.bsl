...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//30.05.2023 Добавлены поля формы "Контактное лицо" и "Согласованная скидка"
	...
	ПолеСогласованнаяСкидка = Элементы.Добавить("ПолеСогласованнаяСкидка", Тип("ПолеФормы"), Элементы.ГруппаШапкаЛево);
	ПолеСогласованнаяСкидка.ПутьКДанным = "Объект.ПТ_СогласованнаяСкидка";
